...
<form id="listPage" name="listPage" action="category-service!list.action" method="post">
<table border="0" cellpadding="0" cellspacing="1" id="searchbg" align="center" width="98%">
	...
	<s:if test="%{channelList.size() > 0}">
		...
		<td><input type="button" id="search" name="search" value="Search" onClick="javascript:doSubmit('listPage','category-service!list.action')"></td>
		<td><input type="button" id="create" name="create" value="Create" onClick="javascript:doSubmit('listPage','category-service!input.action')"></td>
	</tr>
</table>
<div class="spacer-2"></div>
<table id="table-stripe" border="0" cellpadding="0" cellspacing="1" class="stripe" align="center" width="98%">
	...
	<s:iterator value="pageInfo.result">
		<tr>
			<td height="23" align="center"><img class="pointerImage" border="0" title="Edit" src="/common/image/edit_inline.gif" onClick="javascript:doSubmit('listPage','category-service!input.action?serviceId=<s:property  value='serviceId' />');"></td>
			<td><s:property value="serviceName" /></td>
			<td><s:property value="serviceFileName" /></td>
			<td><s:property value="serviceDescription" /></td>
			<td align="center"><img class="pointerImage" border="0" title="Delete" src="/common/image/delete_inline.gif" onClick="javascript:if (confirm('当前类别将被删除,是否继续?')) doSubmit('listPage','category-service!delete.action?serviceId=<s:property  value='serviceId' />');"></td>
		</tr>
	</s:iterator>
</table>
