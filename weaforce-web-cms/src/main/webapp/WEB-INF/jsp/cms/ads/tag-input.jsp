...
<table border="0" align="center" width="100%" class="navigator-title">
	<tr>
		<td valign="middle" height="29" align="left">&nbsp;<img src="/common/image/point.gif" width="5" height="6" >&nbsp;系统导航-&gt;<a href="tag.action">广告目录标签</a>-&gt;标签维护</td>
	</tr>
</table>
...
<table id="theTable" border="0" cellpadding="0" cellspacing="1" class="stripe" align="center" width="98%">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="stripe">
			...
			<tr>
				<td height="30">栏目:</td>
				<td><s:select id="categoryId" name="categoryId" value="%{tagCategory.categoryId}" list="categoryList" listKey="categoryId" listValue="categoryName" /></td>
				<td>名称:</td>
			...
			<tr>
				<td height="30">描述:</td>
				<td colspan="7"><textarea id="tagDescription" name="tagDescription" rows="5" cols="88"><s:property value="tagDescription" /></textarea></td>
			</tr>
