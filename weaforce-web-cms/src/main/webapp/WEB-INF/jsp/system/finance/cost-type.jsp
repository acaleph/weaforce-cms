...
<table border="0" align="center" width="100%" class="navigator-title">
	<tr>
		<td valign="middle" height="29" align="left">&nbsp;<img src="/common/image/point.gif" width="5" height="6" >&nbsp;系统导航-&gt;费用类型字典域</td>
	</tr>
</table>
<div class="spacer-10"></div>
<form id="listPage" name="listPage" action="role!list.action"
	method="post">
<table border="0" cellpadding="0" cellspacing="1" id="searchbg"
	align="center" width="98%">
	<tr align="center">
		<td>英文名称:<input name="queryTypeName"
			value="<s:property value="queryTypeName" />" class="text"></td>
		<td><input type="button" id="search" name="search" value="Search"
			onClick="javascript:doSubmit('listPage','cost-type!list.action')"></td>
		<td><input type="button" id="create" name="create" value="create"
			onClick="javascript:doSubmit('listPage','cost-type!input.action')"></td>
	</tr>
</table>
<div class="spacer-10"></div>
	...
	<s:iterator value="pageInfo.result">
		<tr align="left">
			<td height="23"><security:authorize ifAnyGranted="ROLE_CONE_CRUD_USER"><img class="pointerImage" border="0"
				...
				onClick="javascript:doSubmit('listPage','cost-type!input.action?typeId=<s:property  value='typeId' />');"></security:authorize></td>
			<td><s:property value="typeName" /></td>
			<td><s:if test="%{typeIsActive == 1}">Yes</s:if><s:else>No</s:else></td>
			<td><security:authorize ifAnyGranted="ROLE_CONE_CRUD_USER"><img class="pointerImage" border="0" title="Delete"
				...
				onClick="javascript:if (confirm('是否要删除当前费用类型?')) doSubmit('listPage','cost-type!delete.action?typeId=<s:property  value='typeId' />');"></security:authorize></td>
		</tr>
	</s:iterator>
</table>
