...
$(document).ready(function(){
	...
	$('#parentId').change(function(){
		$('#childId').buildSelect($('#childId'),{selected:0,url:"/cms/page-link!getLinkDDL.action",data:{'parentId':$(this).val()}},function(){});
	})
})
</script>
</head>
...
<table border="0" align="center" width="100%" class="navigator-title">
	<tr>
		<td valign="middle" height="29" align="left">&nbsp;<img src="/common/image/point.gif" width="5" height="6" >&nbsp;系统导航-&gt;<a href="page-link.action">制定页面</a>-&gt;页面文章</td>
	</tr>
</table>
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td><s:select id="parentId" name="parentId" list="linkParentList" listKey="linkId" listValue="linkName" cssClass="required" /></td>
				<td align="left">子节点<font color="red">*</font>:</td>
				<td><s:select id="childId" name="childId" list="articleLinkList" listKey="linkId" listValue="linkName" cssClass="required" /></td>
				<td align="left" >标签:</td>
			...
			<tr>
				...
				<td><input id="linkOrder" name="linkOrder" value="<s:property value='linkOrder' />"></td>
			</tr>
			<tr>
				<td height="30" align="left" >链接:</td>
				<td><input id="linkUrl" name="linkUrl" value="<s:property value='linkArticle.articleUrl' />" size="28" ></td>
				<td align="left">图片:</td>
				<td><input id="linkImageUrl" name="linkImageUrl" value="<s:property value='linkArticle.articleImageUrl' />" size="28" ></td>
			</tr>
			<!-- 文章信息 -->
			<tr>
