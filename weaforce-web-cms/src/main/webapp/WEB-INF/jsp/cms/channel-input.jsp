...
<table id="theTable" border="0" cellpadding="0" cellspacing="1" class="stripe" align="center" width="98%">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="stripe">
			...
			<tr>
				<td height="30">URL:</td>
				<td><input id="channelUrl" name="channelUrl" value="<s:property value='channelUrl' />" size="38" class="required"></td>

			</tr>
			<tr>
				<td height="30">路径:</td>
				<td><input id="channelPath" name="channelPath" value="<s:property value='channelPath' />" size="38"></td>
			</tr>
			<tr>
				<td height="30">排序:</td>
			...
			<tr>
				<td height="30">有效:</td>
				<td><input type="hidden" id="channelIsActive" name="channelIsActive" size="1" value="<s:property value='channelIsActive' />">  <input type="checkbox" id="setActive" name="setActive" onclick="javascript:(this.checked)? document.channelForm.channelIsActive.value=1:document.channelForm.channelIsActive.value=0;"></td>
			</tr>
			<tr>
				<td height="30">描述:</td>
