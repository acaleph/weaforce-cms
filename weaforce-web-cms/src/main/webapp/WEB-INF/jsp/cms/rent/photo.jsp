...
<table border="0" cellpadding="0" cellspacing="1" id="searchbg" align="center" width="98%">
	<tr align="center">
		...
		<td><input type="button" name="search" value="Search" onClick="javascript:doSubmit('listPage','photo!list.action')"></td>
		<td><input type="button" name="create" value="Create" onClick="javascript:doSubmit('listPage','photo!input.action')"></td>
	</tr>
</table>
<div class="spacer-2"></div>
<table id="table-stripe" border="0" cellpadding="0" cellspacing="1" class="stripe" align="center" width="98%">
	...
	<s:iterator value="pageInfo.result">
		<tr>
			...
			<td><s:property value="photoUrlSmall" /></td>
