...
<table border="0" cellpadding="0" cellspacing="1" id="searchbg" align="center" width="98%">
	<tr align="left">
		...
		<security:authorize ifAnyGranted="ROLE_CMS_CRUD_USER">
			<td><input type="button" id="create" name="create" value="Create" onClick="javascript:doSubmit('listPage','page-link!input.action?fid=1')"></td>
		</security:authorize>
	</tr>
</table>
<div class="spacer-2"></div>
<table id="table-stripe" border="0" cellpadding="0" cellspacing="1" class="stripe" align="center" width="98%">
	...
	<s:iterator value="pageInfo.result">
		<tr>
			...
			<td><img class="pointerImage" border="0" title="发布" src="/common/image/reset_inline.gif" onClick="javascript:if (confirm('是否要发布(parse)自定义页面?')) doSubmit('listPage','page-link!parse.action?linkId=<s:property  value='linkId' />');"></td>
			<td><s:property value="linkUrl" /></td>
			<td><s:property value="linkPictureUrl" /></td>
			<td width="33" align="center"><img class="pointerImage" border="0" title="Tree" src="/common/image/tree_inline.gif" onClick="javascript:doSubmit('listPage','page-link-tree.action?linkId=<s:property value='linkId' />');"></td>
