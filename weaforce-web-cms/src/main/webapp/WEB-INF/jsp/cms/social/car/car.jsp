...
$(document).ready(function(){
	...
	$('#brandId').change(function(){
		$('#seriesId').buildSelect($('#seriesId'),{selected:0,url:"/cms/social/car/series!getSeriesDDL.action",data:{'brandId':$(this).val()}},function(){});
	})
})
</script>
<title>文章管理</title>
...
<table border="0" cellpadding="0" cellspacing="1" id="searchbg" align="center" width="98%">
	<tr align="center">
		...
		<td>栏目:</td>
		<td><s:select id="seriesId" name="seriesId" value="%{seriesId}" list="seriesList" listKey="seriesId" listValue="seriesName" /></td>
